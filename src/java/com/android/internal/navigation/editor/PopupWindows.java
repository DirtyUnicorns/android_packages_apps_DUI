...
public class PopupWindows {
    ...
    // helper methods for res reflection
    public static int getDrawableId(String name, Context ctx) {
        return DUActionUtils.getIdentifier(ctx, name, DUActionUtils.DRAWABLE,
                DUActionUtils.PACKAGE_SYSTEMUI);
    }

    public static int getLayoutId(Context ctx, String name) {
        return DUActionUtils.getIdentifier(ctx, name,
                "layout", DUActionUtils.PACKAGE_SYSTEMUI);
    }

    public static int getStyleId(Context ctx, String name) {
        return DUActionUtils.getIdentifier(ctx, name,
                "style", DUActionUtils.PACKAGE_ANDROID);
    }

    public static int getId(Context ctx, String name) {
        return DUActionUtils.getId(ctx, name,
                DUActionUtils.PACKAGE_SYSTEMUI);
    }
