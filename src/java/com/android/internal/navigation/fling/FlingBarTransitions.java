...
*/
    ...
    private int findViewByIdName(String name) {
        return DUActionUtils.getId(mView.getContext(), name,
                DUActionUtils.PACKAGE_SYSTEMUI);
    }
    ...
    private void applyLightsOut(boolean lightsOut, boolean animate, boolean force) {
        ...
        final View navButtons = mView.getCurrentView().findViewById(findViewByIdName("nav_buttons"));
        final View lowLights = mView.getCurrentView().findViewById(findViewByIdName("lights_out"));
